...
class APIHandler(object):
    ...
    def api_v1_list_all_GET(self, req):
        return ', '.join(vm_manager.list_all())

    def api_v1_create_PUT(self, req):
        return vm_manager.create(**req.json)

    def api_v1_delete_DELETE(self, req):
        return vm_manager.delete(**req.json)

    def api_v1_reboot_POST(self, req):
        return vm_manager.reboot(**req.json)

    def api_v1_power_on_POST(self, req):
        return vm_manager.power_on(**req.json)

    def api_v1_power_off_POST(self, req):
        return vm_manager.power_off(**req.json)
